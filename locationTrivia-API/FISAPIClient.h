...
- (void)requestLocationsWithSuccess:(void (^)(NSArray *locations))success
                            failure:(void (^)(NSError *error))failure;

- (void)createLocationWithName:(NSString *)name
                      Latitude:(NSNumber *)latitude
                     longitude:(NSNumber *)longitude
                   withSuccess:(void (^)(NSDictionary *location))success
                       failure:(void (^)(NSError *error))failure;
...
- (void)createTriviumWithContent:(NSString *)content
               forLocationWithID:(NSString *)locationID
                         success:(void (^)(NSDictionary *trivium))success
                         failure:(void (^)(NSError *error))failure;
